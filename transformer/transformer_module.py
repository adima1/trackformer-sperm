...
class TrackFormerModel(nn.Module):
    def __init__(self, num_classes, hidden_dim=256, num_queries=100, track_memory_size=5):
        super().__init__()
        self.backbone = ...  # TODO: Define your backbone (e.g., ResNet)
    ...
    def match_to_memory(self, curr_embeds, curr_boxes):
        ...
        cost_similarity = 1 - similarity_matrix.cpu().numpy()
        ...
        cost_center = torch.cdist(curr_centers, prev_centers, p=2).cpu().numpy()
